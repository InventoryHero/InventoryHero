...
const nameRules = ref([
  (value: string | undefined | null) =>
    !!value || t('boxes.box.edit.rules.name_required')
])
...
const parentRules = ref([
  (value: RoomResponseSchema | null | undefined) =>
    !!value || t('boxes.box.edit.rules.parent_required')
])
...
const resetParent = () => {
  newParent.value = box.value.parent!
}
...
<template>
  <v-dialog
    ...
    :width="width"
  >
    <v-card :title="t('boxes.box.edit.title', { name: box.name })">
